...
class Buyuyendortgen extends StatefulWidget {
  const Buyuyendortgen({Key? key}) : super(key: key);

  @override
  _BuyuyendortgenState createState() => _BuyuyendortgenState();
}

class _BuyuyendortgenState extends State<Buyuyendortgen> {
