...
class Buyuyenyedigen extends StatefulWidget {
  const Buyuyenyedigen({Key? key}) : super(key: key);

  @override
  _BuyuyenyedigenState createState() => _BuyuyenyedigenState();
}

class _BuyuyenyedigenState extends State<Buyuyenyedigen> {
