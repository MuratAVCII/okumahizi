...
class Buyuyenucgen extends StatefulWidget {
  const Buyuyenucgen({Key? key}) : super(key: key);

  @override
  _BuyuyenucgenState createState() => _BuyuyenucgenState();
}

class _BuyuyenucgenState extends State<Buyuyenucgen> {
