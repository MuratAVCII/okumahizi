...
class Buyuyensekizgen extends StatefulWidget {
  const Buyuyensekizgen({Key? key}) : super(key: key);

  @override
  _BuyuyensekizgenState createState() => _BuyuyensekizgenState();
}

class _BuyuyensekizgenState extends State<Buyuyensekizgen> {
