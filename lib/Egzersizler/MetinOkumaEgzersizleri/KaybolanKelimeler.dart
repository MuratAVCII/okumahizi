...
void main() {
  runApp(const MaterialApp(home: KaybolanKelimeler()));
}

class KaybolanKelimeler extends StatefulWidget {
  const KaybolanKelimeler({super.key});

  @override
  _KaybolanKelimelerState createState() => _KaybolanKelimelerState();
}

class _KaybolanKelimelerState extends State<KaybolanKelimeler> {
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const KaybolanKelimeler()));
              },
      ...
      spans.add(TextSpan(
        ...
        style: TextStyle(
          ...
          color: globalIndex < _currentWordIndex
              ? const Color(0xFFD5B59C)
              : Colors.black, // Kelimeleri kırmızıya döndür
        ),
      ));
    }
